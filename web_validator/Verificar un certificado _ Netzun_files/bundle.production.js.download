...
o.p="//static.hsappstatic.net/head-dlb/static-1.1074/"
...
e&&this.config(e.dsn,e.config).install()},showReportDialog:function(e){if(I){var t=(e=e||{}).eventId||this.lastEventId()
...
a.email&&(o+="&email="+n(a.email))}var i=this._getGlobalServer(this._parseDSN(r)),l=I.createElement("script")
l.async=!0
l.src=i+"/api/embed/error-page/"+o;(I.head||I.body).appendChild(l)}},_ignoreNextOnError:function(){var e=this
...
I.createEvent?(r=I.createEvent("HTMLEvents")).initEvent(e,!0,!0):(r=I.createEventObject()).eventType=e
for(n in t)y(t,n)&&(r[n]=t[n])
if(I.createEvent)I.dispatchEvent(r)
else try{I.fireEvent("on"+r.eventType.toLowerCase(),r)}catch(e){}}},_breadcrumbEventHandler:function(e){var t=this
...
C(o,"removeEventListener",(function(e){return function(t,r,n,o){try{r=r&&(r.__raven_wrapper__?r.__raven_wrapper__:r)}catch(e){}return e.call(this,t,r,n,o)}}),t)}}C(D,"setTimeout",r,t)
C(D,"setInterval",r,t)
D.requestAnimationFrame&&C(D,"requestAnimationFrame",(function(t){return function(r){return t(e.wrap(r))}}),t)
...
function n(t,r){t in r&&p(r[t])&&C(r,t,(function(t){return e.wrap(t)}))}if(t.xhr&&"XMLHttpRequest"in D){var o=XMLHttpRequest.prototype
...
return t.apply(this,arguments)}}),r)}t.xhr&&"fetch"in D&&C(D,"fetch",(function(t){return function(r,n){for(var o=new Array(arguments.length),a=0;a<o.length;++a)o[a]=arguments[a]
var i,s=o[0],l="GET"
...
return e}))}}),r)
if(t.dom&&this._hasDocument)if(I.addEventListener){I.addEventListener("click",e._breadcrumbEventHandler("click"),!1)
I.addEventListener("keypress",e._keypressEventHandler(),!1)}else{I.attachEvent("onclick",e._breadcrumbEventHandler("click"))
I.attachEvent("onkeypress",e._keypressEventHandler())}var a=D.chrome,i=!(a&&a.app&&a.app.runtime)&&D.history&&history.pushState&&history.replaceState
...
C(history,"replaceState",l,r)}if(t.console&&"console"in D&&console.log){var u=function(t,r){e.captureBreadcrumb({message:t,level:r.level,category:"console"})}
b(["debug","info","warn","error","log"],(function(e,t){j(console,t,u)}))}},_restoreBuiltIns:function(){for(var e;this._wrappedBuiltIns.length;){var t=(e=this._wrappedBuiltIns.shift())[0],r=e[1],n=e[2]
...
try{for(;n--;)r[R[n]]=t[n]||""}catch(t){throw new s("Invalid DSN: "+e)}if(r.pass&&!this._globalOptions.allowSecretKey)throw new s("Do not specify your secret key in the DSN. See: http://bit.ly/raven-secret-key")
...
if(this._hasDocument){I.location&&I.location.href&&(e.url=I.location.href)
if(I.referrer){e.headers||(e.headers={})
e.headers.Referer=I.referrer}}return e}},_resetBackoff:function(){this._backoffDuration=0
...
//# sourceMappingURL=//static.hsappstatic.net/head-dlb/static-1.1074/bundle.production.js.map